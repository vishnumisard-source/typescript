...
let students1:string[]=["john","jane","jim"];
...
let data2: number = students1.length; //length property returns the number of elements in the array
//pop..no need to pass the parameters
...
let data4:any[]=[1,"hello",true,2.5];

let employees:string[]=["john","jane","jim"];
